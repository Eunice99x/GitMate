...
export async function POST(request: Request) {
  try {
    ...
    const {repositoryName, pullRequestNumber, tone, provider, githubToken, openaiKey, googleKey} = body;
    ...
    try {
      ...
      const review = await generateReview(diffText, reviewTone, provider, {openaiKey, googleKey});
