...
import {CheckIcon, GitlabIcon as GitHubLogoIcon, RocketIcon, BarChart3Icon, MessageSquareIcon, GemIcon as GearIcon, CodeIcon, ArrowRightIcon, XIcon} from "lucide-react";
  ...
  const features = [
    {
      ...
      details: ["Detect code smells and anti-patterns", "Suggest better variable names and structures", "Identify performance bottlenecks", "Provide actionable recommendations"]
    },
    {
      ...
      details: ["Constructive Critic for detailed feedback", "Friendly Mentor for supportive guidance", "Enthusiastic Coach for positive reinforcement", "Custom tones for Team plan subscribers"]
    },
    {
      ...
      details: ["Track code quality trends over time", "Identify recurring issues across repositories", "Get personalized improvement suggestions", "Compare against industry best practices"]
    },
    {
      ...
      details: ["Automatic PR reviews", "Command-based reviews (/gitmate review)", "Detailed inline comments", "Status checks integration"]
    },
    {
      ...
      details: ["Generate clear, descriptive commit messages", "Follow best practices automatically", "Save time on routine commits", "Maintain consistent commit style"]
    },
    {
      title: "Team Performance Tracking",
      description: "Monitor code quality trends and improvements across your repositories.",
      icon: <BarChart3Icon className='h-12 w-12 text-primary' />,
      details: ["Track team-wide code quality metrics", "Identify areas for improvement", "Celebrate quality improvements", "Set and monitor quality goals"]
    }
  ];
          ...
          <div className='container px-4 md:px-6'>
            <div className='flex flex-col items-center space-y-4 text-center'>
              <div className='space-y-2'>
                ...
                <p className='mx-auto max-w-[700px] text-muted-foreground md:text-xl'>Discover how GitMate can improve your code quality and development workflow</p>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className='container px-4 md:px-6'>
            <div className='grid gap-10 lg:grid-cols-2'>
              <div className='space-y-4'>
                ...
                <p className='text-muted-foreground md:text-xl'>GitMate uses advanced AI models to provide detailed, helpful code reviews that go beyond what traditional static analysis tools can offer.</p>
          ...
          <div className='container px-4 md:px-6'>
            <div className='flex flex-col items-center space-y-4 text-center'>
              <div className='space-y-2'>
                ...
                <p className='mx-auto max-w-[700px] text-muted-foreground md:text-xl'>Choose the plan that best fits your needs</p>
              </div>
            </div>
