        ...
        <div className='container px-4 md:px-6'>
          <div className='mx-auto max-w-[800px] space-y-8'>
            <div className='space-y-2'>
              ...
              <p className='text-muted-foreground'>Follow these steps to set up the required environment variables for GitMate.</p>
            </div>

            <Alert>
              <InfoIcon className='h-4 w-4' />
              <AlertTitle>Important</AlertTitle>
              <AlertDescription>Keep your API keys and tokens secure. Never commit them to your repository or share them publicly.</AlertDescription>
            </Alert>
            ...
            <div className='space-y-6'>
              ...
              <Card>
                ...
                <CardContent className='space-y-4'>
                  ...
                  <div className='space-y-2'>
                    ...
                    <p className='text-sm text-muted-foreground'>A Personal Access Token with appropriate permissions to access repositories and create comments.</p>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Required for AI-powered code reviews. At least one provider is required.</CardDescription>
                </CardHeader>
                <CardContent className='space-y-4'>
                  <div className='space-y-2'>
                    <div className='font-mono text-sm'>GOOGLE_API_KEY</div>
                    <p className='text-sm text-muted-foreground'>Your Google Gemini API key for accessing Gemini models (recommended).</p>
                  ...
                  <div className='space-y-2'>
                    ...
                    <p className='text-sm text-muted-foreground'>Your OpenAI API key for accessing GPT models (optional).</p>
                  </div>
                  <div className='space-y-2'>
                    <div className='font-mono text-sm'>DEFAULT_AI_PROVIDER</div>
                    <p className='text-sm text-muted-foreground'>The default AI provider to use ("gemini" or "openai"). Defaults to "gemini" if not specified.</p>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent className='space-y-4'>
                  <div className='space-y-2'>
                    ...
                    <p className='text-sm text-muted-foreground'>The base URL of your application (e.g., http://localhost:3000 for development).</p>
                  </div>
                  <div className='space-y-2'>
                    <div className='font-mono text-sm'>NEXTAUTH_SECRET</div>
                    <p className='text-sm text-muted-foreground'>A random string used to hash tokens and sign cookies. Generate a secure random string.</p>
                  </div>
                </CardContent>
              </Card>
            </div>
            ...
            <div className='space-y-6'>
              ...
              <Tabs defaultValue='local' className='w-full'>
                ...
                <TabsContent value='local' className='space-y-4 mt-4'>
                  <p>
                    For local development, create a <code className='font-mono text-sm bg-muted px-1 py-0.5 rounded'>.env.local</code> file in the root of your project with the following variables:
                  </p>
...
NEXTAUTH_SECRET=your_random_secret_string`}</pre>
                  ...
                  <Alert className='bg-muted/50 mt-4'>
                    ...
                    <AlertDescription>
                      You can generate a secure random string for NEXTAUTH_SECRET using the command: <code className='font-mono text-sm bg-muted px-1 py-0.5 rounded'>openssl rand -base64 32</code>
                    </AlertDescription>
                  </Alert>
                </TabsContent>
              ...
              <Card>
                ...
                <CardContent className='space-y-4'>
                  ...
                  <Alert className='mt-4'>
                    ...
                    <AlertDescription>Google Gemini offers a generous free tier that's suitable for most GitMate usage.</AlertDescription>
                  </Alert>
                  <div className='mt-4'>
            ...
            <div className='space-y-4'>
              ...
              <p>Once you've set up all the required environment variables, you can start using GitMate. Check out the documentation for more information on how to use the application.</p>
