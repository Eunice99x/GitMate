  ...
  const faqs = [
    {
      ...
      answer:
        "Our free trial gives you full access to the Pro or Team plan for 14 days. No credit card required. At the end of the trial, you can choose to subscribe or downgrade to the Free plan.",
    },
    {
      question: "Can I change plans later?",
      answer:
        "Yes, you can upgrade, downgrade, or cancel your subscription at any time. If you upgrade, you'll be charged the prorated difference. If you downgrade, you'll receive credit towards future billing cycles.",
    },
    {
      question: "How does repository counting work?",
      answer:
        "A repository counts towards your plan limit when GitMate is actively installed and configured to review code. You can add and remove repositories at any time within your plan limits.",
    },
    {
      question: "Is there a plan for open source projects?",
      answer:
        "Yes! We offer free Team plans for qualifying open source projects. Contact our support team to apply for the open source program.",
    },
    {
      question: "What payment methods do you accept?",
      answer:
        "We accept all major credit cards, PayPal, and for annual Team plans, we can also support invoicing and purchase orders.",
    },
    {
      question: "How secure is GitMate?",
      answer:
        "GitMate uses GitHub's OAuth and doesn't store your code. We only process the diffs during review. Our service is SOC 2 compliant and we regularly undergo security audits.",
    },
  ]
