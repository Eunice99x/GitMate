            ...
            <Card>
              ...
              <CardContent className='space-y-6'>
                ...
                <div className='space-y-3'>
                  ...
                  <RadioGroup defaultValue={aiProvider} onValueChange={setAiProvider} className='flex flex-col space-y-1'>
                    <div className='flex items-center space-x-2'>
                ...
                <div className='space-y-3'>
                  ...
                  <div className='space-y-2'>
                    <Slider defaultValue={[maxReviewSize]} max={5000} min={100} step={100} onValueChange={value => setMaxReviewSize(value[0])} />
              ...
              <CardContent className='space-y-6'>
                <div className='space-y-3'>
                  ...
                  <div className='flex items-center justify-between'>
                    ...
                    <Switch id='email-notifications' checked={emailNotifications} onCheckedChange={setEmailNotifications} disabled={!notificationsEnabled} />
                  </div>
                </div>
                ...
                <div className='space-y-3'>
                  ...
                  <Input type='email' placeholder='your.email@example.com' disabled={!emailNotifications || !notificationsEnabled} />
                  <p className='text-xs text-muted-foreground'>We'll send notifications about new reviews and important updates.</p>
                </div>
              </CardContent>
            </Card>
          </div>
