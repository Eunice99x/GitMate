...
const navigation = {
  product: [
    ...
    {name: "GitHub", href: "https://github.com/gitmate"}
  ],
  company: [
  ...
  social: [
    {
      name: "Twitter",
      href: "https://twitter.com/gitmate",
      icon: (props: any) => (
      ...
      <div className='container px-4 sm:px-6 lg:px-8 py-12 sm:py-16'>
        <div className='xl:grid xl:grid-cols-3 xl:gap-8'>
          <div className='space-y-8'>
            ...
            <p className='text-sm leading-6 text-muted-foreground'>Making code reviews smarter and faster with AI.</p>
          </div>
              ...
              <div className='mt-10 md:mt-0'>
                ...
                <ul role='list' className='mt-6 space-y-4'>
                  {navigation.social.map(item => (
                    <li key={item.name}>
                      <Link href={item.href} className='text-sm leading-6 text-muted-foreground hover:text-foreground flex items-center gap-2'>
        ...
        <div className='mt-16 border-t pt-8 sm:mt-20 lg:mt-24'>
          <p className='text-xs leading-5 text-muted-foreground'>&copy; {new Date().getFullYear()} GitMate. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
